...
- **Ground every scenario in the description**, especially Constraints — a scenario the agent can't possibly satisfy (or a guardrail it _should_ refuse) must have expectations that reflect that.
